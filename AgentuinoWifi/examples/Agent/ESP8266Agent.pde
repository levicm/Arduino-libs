...
void pduReceived()
{
  ...
  //
  #ifdef DEBUG
    Serial << "UDP Packet Received Start.." << " RAM:" << ESP.getFreeHeap() << endl;
  #endif
  //
  ...
  if ( pdu.type == SNMP_PDU_GET || pdu.type == SNMP_PDU_GET_NEXT || pdu.type == SNMP_PDU_SET
    ...
    if ( strcmp_P(oid, sysDescr ) == 0 ) {
      ...
      //
      #ifdef DEBUG
        Serial << "sysObjectID..." << locObjectID << " " << pdu.VALUE.size << endl;
      #endif
  ...
  //
  Serial << "UDP Packet Received End.." << " RAM:" << ESP.getFreeHeap() << endl;
}
